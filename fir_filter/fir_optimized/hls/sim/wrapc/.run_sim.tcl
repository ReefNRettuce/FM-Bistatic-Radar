...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fir_optimized.autotvin.dat"
	set constFileTvOut       "fir_optimized.autotvout.dat"
	set constFileHdlTvIn     "fir_optimized.autohdltvin.dat"
	set constFileHdlTvOut    "fir_optimized.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
