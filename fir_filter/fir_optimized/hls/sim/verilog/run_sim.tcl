...
if {[file isfile fir_optimized.autotvin.dat]} {
	file delete -force fir_optimized.autotvin.dat
}

if {[file isfile fir_optimized.autotvout.dat]} {
	file delete -force fir_optimized.autotvout.dat
}
