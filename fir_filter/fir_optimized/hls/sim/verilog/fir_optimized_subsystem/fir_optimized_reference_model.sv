...
`ifndef FIR_OPTIMIZED_REFERENCE_MODEL_SV
`define FIR_OPTIMIZED_REFERENCE_MODEL_SV

class fir_optimized_reference_model extends uvm_component;
    event allsvr_input_done;
    event allsvr_output_done;
    int trans_num_total = 2000;
    int trans_num_idx;
    int ap_done_cnt=1;
    ...
    `uvm_component_utils_begin(fir_optimized_reference_model)
