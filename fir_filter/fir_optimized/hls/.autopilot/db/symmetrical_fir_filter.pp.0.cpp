# 1 "../HLS/symmetrical_fir_filter.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../HLS/symmetrical_fir_filter.cpp" 2
...
# 4 "../HLS/symmetrical_fir_filter.cpp" 2

typedef int coeff_t;
typedef int data_t;
typedef int acc_t;

__attribute__((sdx_kernel("fir_optimized", 0))) void fir_optimized(data_t *output, data_t input) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=fir_optimized
# 9 "../HLS/symmetrical_fir_filter.cpp"
